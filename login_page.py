...
class login_page:
    def __init__(self, root):
        self.window = root
        self.window.title("Log In MiniApes")
        # Set the window size
        ...
        label1 = Label(self.frame1, text= "Mini Apes", font=("times new roman", 40, "bold"), bg="yellow", fg="brown").place(x=100,y=300)
        #label2 = Label(self.frame1, text= "", font=("times new roman", 40, "bold"), bg="yellow", fg="RoyalBlue1").place(x=162,y=300)
        label3 = Label(self.frame1, text= "By JADA", font=("times new roman", 13, "bold"), bg="yellow", fg="brown4").place(x=100,y=360)
